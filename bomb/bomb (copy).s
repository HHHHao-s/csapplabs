...
0000000000400ee0 <phase_1>:00
  400ee0:	48 83 ec 08          	sub    $0x8,%rsp
  400ee4:	be 00 24 40 00       	mov    $0x4024,%esi
...
0000000000400efc <phase_2>:
  ...
  400f0e:	74 20                	je     400f30 <phase_2+0x34> //%rsp==1 j L1
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34> //j L1
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax // L3
  400f1a:	01 c0                	add    %eax,%eax
  400f1c:	39 03                	cmp    %eax,(%rbx)
  400f1e:	74 05                	je     400f25 <phase_2+0x29> // %eax == (%rbx) j L2
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx // L2
  400f29:	48 39 eb             	cmp    %rbp,%rbx
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b> // %rbp != %rbx j L3
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40> // j L4
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx   //L1 rbx==2
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp	// 
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b> // j L3
  400f3c:	48 83 c4 28          	add    $0x28,%rsp // L4
  400f40:	5b                   	pop    %rbx
  400f41:	5d                   	pop    %rbp
  400f42:	c3                   	retq   
...
0000000000400f43 <phase_3>:
  ...
  400f63:	7f 05                	jg     400f6a <phase_3+0x27> // amount of numbers > 1 j L1
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp) // L1 represent the first number
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a> // (%rsp+8)>7||(%rsp+8)<0 bomb
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8) // table address
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax // 1
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b> // jmp L2
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax // L2
  400fc2:	74 05                	je     400fc9 <phase_3+0x86> // (%rsp + 12) == %eax  return
...
0000000000400fce <func4>:
  ...
  400fd2:	89 d0                	mov    %edx,%eax //eax = edx //edx == 14
  ...
  400fdd:	d1 f8                	sar    %eax //eax >>= 1 //== edx - esi + (edx-esi>>31)
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx //ecx = (edx-esi)>>31+(edx-esi+(edx-esi>>31)+rsi)>>2
  400fe2:	39 f9                	cmp    %edi,%ecx
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>// ecx <= edi j L1
  ...
  400ffe:	e8 cb ff ff ff       	callq  400fce <func4> func(rcx-1, )
...
000000000040100c <phase_4>:
  ...
  40102c:	75 07                	jne    401035 <phase_4+0x29> // eax != 2 boom!
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp) 
  401033:	76 05                	jbe    40103a <phase_4+0x2e> // (rsp + 8) <= 14 j L1
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx // L1
  40103f:	be 00 00 00 00       	mov    $0x0,%esi 
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi
  401048:	e8 81 ff ff ff       	callq  400fce <func4> func4(0, 0x8(%rsp))
  40104d:	85 c0                	test   %eax,%eax
  40104f:	75 07                	jne    401058 <phase_4+0x4c> // eax != 0 j boom!
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)
  401056:	74 05                	je     40105d <phase_4+0x51> // (rsp + 12) == 0 return
...
0000000000401062 <phase_5>:
  ...
  401082:	74 4e                	je     4010d2 <phase_5+0x70> //eax==6 jl1
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx //l2
  ...
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax             // loop 6
  4010ac:	75 dd                	jne    40108b <phase_5+0x29> rax!=6 jl2
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal>
  4010c2:	85 c0                	test   %eax,%eax
  4010c4:	74 13                	je     4010d9 <phase_5+0x77> // strings_equal return 
  4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb>
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77> // return
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax             // l1
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29> // jl2
...
00000000004010f4 <phase_6>:
  ...
  401114:	4c 89 ed             	mov    %r13,%rbp // *r13 refelect the first number
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34> // the 1<=all<=6 jl1
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d // l1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d // 
  401130:	74 21                	je     401153 <phase_6+0x5f> // r12d == 6 jl2
  401132:	44 89 e3             	mov    %r12d,%ebx
  401135:	48 63 c3             	movslq %ebx,%rax // l4
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51> // eax != *rbp jl3
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb> 
  401145:	83 c3 01             	add    $0x1,%ebx // l3
  401148:	83 fb 05             	cmp    $0x5,%ebx 
  40114b:	7e e8                	jle    401135 <phase_6+0x41> // ebx <= 5 jl4
  40114d:	49 83 c5 04          	add    $0x4,%r13
  401151:	eb c1                	jmp    401114 <phase_6+0x20> // j
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi // l2 
  401158:	4c 89 f0             	mov    %r14,%rax // ebx==6
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx
  401160:	89 ca                	mov    %ecx,%edx // l5
  401162:	2b 10                	sub    (%rax),%edx // edx -= *rax
  401164:	89 10                	mov    %edx,(%rax) // *rax = edx
  401166:	48 83 c0 04          	add    $0x4,%rax // rax+=4
  40116a:	48 39 f0             	cmp    %rsi,%rax
  40116d:	75 f1                	jne    401160 <phase_6+0x6c> // jl5
  						//loop from the first to the last input
  						//every number sub by the 7
  40116f:	be 00 00 00 00       	mov    $0x0,%esi
  401174:	eb 21                	jmp    401197 <phase_6+0xa3> // jl6
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx // l7
  40117a:	83 c0 01             	add    $0x1,%eax
  40117d:	39 c8                	cmp    %ecx,%eax
  40117f:	75 f5                	jne    401176 <phase_6+0x82> // 7 != eax j l7
  401181:	eb 05                	jmp    401188 <phase_6+0x94> // jl8
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx // l14
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) // l8
  40118d:	48 83 c6 04          	add    $0x4,%rsi
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7> // rsi==0x18 jl9
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx // l6
  40119a:	83 f9 01             	cmp    $0x1,%ecx
  40119d:	7e e4                	jle    401183 <phase_6+0x8f> // ecx <= 1 jl14
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82> // jl7
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx // l9
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi
  4011ba:	48 89 d9             	mov    %rbx,%rcx
  4011bd:	48 8b 10             	mov    (%rax),%rdx // l11
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)
  4011c4:	48 83 c0 08          	add    $0x8,%rax
  4011c8:	48 39 f0             	cmp    %rsi,%rax
  4011cb:	74 05                	je     4011d2 <phase_6+0xde> // rsi==rax jl10
  4011cd:	48 89 d1             	mov    %rdx,%rcx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9> // jl11
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx) // l10
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax// l13
  4011e3:	8b 00                	mov    (%rax),%eax
  4011e5:	39 03                	cmp    %eax,(%rbx)
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa> // *rbx >= eax jl12
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx// l12
  4011f2:	83 ed 01             	sub    $0x1,%ebp
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb> // ebp!=0 jl13
